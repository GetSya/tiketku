...
class client extends CI_Controller {
	...
	function keluhan()
	{
		if($this->session->userdata('status')== 'login_member')
		{
			$data['keluhan'] = $this->m_login->keluhan()->result();
	...
	function keluhan_tambah()
	{
		$keluhan_id = $this->input->post('keluhan_id');
		$keluhan_text = $this->input->post('keluhan_text');
		$keluhan_nama = $this->input->post('keluhan_nama');
		$keluhan_email = $this->input->post('keluhan_email');
		
		$where = array(
			'keluhan_id'=>$keluhan_id,
			'keluhan_text'=>$keluhan_text,
			'keluhan_nama'=>$keluhan_nama,
			'keluhan_email'=>$keluhan_email
		);
	
		
		$this->m_login->tambah_keluhan($where);
