...
Class m_master extends CI_MODEL
{
	...
	{
		$sql = "SELECT * FROM mst_location A INNER JOIN mst_location_tipe B ON A.loc_tipe_id=B.loc_tipe_id";
	...
	function load_lokasi_aktif() 
	{
		return $this->db->get_where('mst_location',array('location_aktif' =>'1'));
	}
