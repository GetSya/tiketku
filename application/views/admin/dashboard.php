...
<body id="page-top">
    ...
    <div class="card-body">
        ...
        <a href="https://agramasgroup.com/" class="btn btn-primary" target="_blank">Lihat Detail</a>
    </div>
</div>
<br>
                    </div>
    ...
    <div class="card-body">
        ...
        <a href="https://id.wikipedia.org/wiki/Agam_Tungga_Jaya_dan_Sudiro_Tungga_Jaya" class="btn btn-primary" target="_blank">Lihat Detail</a>
    </div>
</div>
<br>
                    </div>
    ...
    <div class="card-body">
        ...
        <a href="https://id.wikipedia.org/wiki/PO_Haryanto" class="btn btn-primary" target="_blank">Lihat Detail</a>
    </div>
</div>
<br>
                    </div>
    ...
    <div class="card-body">
        ...
        <a href="https://www.gunungharta.com/contact" class="btn btn-primary" target="_blank">Lihat Detail</a>
    </div>
</div>
                    </div>
                </div>
