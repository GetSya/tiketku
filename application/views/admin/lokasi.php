				...
				<div class="modal-body">
					<form id="formTambahLokasi">
						<div class="form-group">
							<label>ID</label>
							<input type="text" value="<?php $rand = rand(100000, 1000000); echo $rand; ?>" readonly value="<?php $rand = rand(100000, 1000000); echo $rand; ?>" readonly name="location_id" class="form-control" />
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
							<label>ID</label>
							<input type="text" readonly id="location_id" name="location_id" class="form-control" />
						</div>
						<div class="form-group">
							<label>Nama Lokasi</label>
						...
						<div class="form-group">
							...
							<option default disabled value="">Pilih</option>
							<?php
							foreach($tipelokasi as $res)
							{
						?>
