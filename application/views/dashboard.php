...
<head>
  ...
  <title>Dashboard | My Ticketing</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title m-0">Agra Mas</h5>
              </div>
              <div class="card-body">
                <img src="<?php echo base_url()?>assets2/img/agramas.jpg" class="card-img-top" alt="">
                <hr>
                <p class="card-text" style="font-style: italic;">Nama Bus : <strong>Agra Mas</strong> <br>Bus Seat : <strong>2 - 2</strong><br>Rute : <strong>JAKARTA - JOGJA</strong>
                <br>Tarif : <strong>Rp. 320.000</strong></p>
                <a href="<?php echo base_url()?>" class="btn btn-danger">Beli Sekarang</a>
              </div>
            </div>
