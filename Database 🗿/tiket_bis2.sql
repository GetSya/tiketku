...
CREATE TABLE `mst_bus` (
  ...
  `bus_makan` tinyint(4) DEFAULT NULL,
...
INSERT INTO `mst_bus` (`bus_id`, `bus_nama`, `tipe_id`, `bus_series`, `bus_kapasitas`, `bus_format_kursi`, `bus_kelas`, `bus_ac`, `bus_snack`, `bus_toilet`, `bus_recliner`, `bus_stopkontak`, `bus_makan`, `bus_aktif`) VALUES
('B 1234 ABC', 'KYM TRANS', 'XHD', 'KYM 144 - BadBoy', 32, '2 - 2', 'EKONOMI', 1, 0, 1, 0, 0, 0, 0),
('B 3434 AC', 'PO. Haryanto', 'XHD', 'HR 155 - PREDATOR', 36, '3 -2', 'EXECUTIVE', 1, 0, 1, 0, 0, 1, 0),
('E 4949 HAH', 'Sudiro Tungga Jaya', 'SHD', 'STJ - PIROSKHA', 26, '2 -2', 'PRESIDENT CLASS', 1, 1, 1, 1, 1, 1, 0);
